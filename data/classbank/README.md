...
Imported JSON is written to `data/classbank/processed/`. Restart ClassPulse; imported lessons then appear beside the three authored demos and replay using their recorded CHAT timestamps. Their events are marked with source `classbank` and retain corpus, media, access, and citation metadata.
