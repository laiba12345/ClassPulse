...
def test_confidence_rewards_distinct_signals_not_repeated_raw_points():
    ...
    assert CCSEngine().score(corroborated).confidence > CCSEngine().score(repeated).confidence
